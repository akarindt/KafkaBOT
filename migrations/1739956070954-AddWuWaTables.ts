...
export class AddWuWaTables1739956070954 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "TBL_WUWA_NOTIFY" ("id" SERIAL NOT NULL, "wuwaSubscribeId" integer NOT NULL, "code" character varying NOT NULL, CONSTRAINT "PK_20c8c4f968cce64d77d2ea18246" PRIMARY KEY ("id", "wuwaSubscribeId", "code"))`
        );
        ...
        await queryRunner.query(
            `CREATE TABLE "TBL_WUWA_SUBSCRIBE" ("id" SERIAL NOT NULL, "userDiscordId" character varying NOT NULL, CONSTRAINT "PK_8d0d00f20b781b8689cbbe90b70" PRIMARY KEY ("id"))`
        );

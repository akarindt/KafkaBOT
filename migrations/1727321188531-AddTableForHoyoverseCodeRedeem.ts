...
export class AddTableForHoyoverseCodeRedeem1727321188531 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "TBL_HOYOVERSE_CODE" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "gameName" character varying NOT NULL, "isActivate" boolean NOT NULL, CONSTRAINT "PK_f9e8f876be85d8c4295f34e0e10" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "TBL_HOYOVERSE_REDEEM" ("id" SERIAL NOT NULL, "hoyoverseId" integer NOT NULL, "code" character varying NOT NULL, "gameName" character varying NOT NULL, "redeemAt" integer NOT NULL, CONSTRAINT "PK_48fdcdaadc33f9e1490d0ccadd8" PRIMARY KEY ("id"))`);

...
export class AddHoyoverseTable1723882328063 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "TBL_HOYOVERSE" ("id" SERIAL NOT NULL, "userDiscordId" character varying NOT NULL, "game" character varying NOT NULL, "cookies" text NOT NULL, CONSTRAINT "PK_4336237ca928715d5fe678206b9" PRIMARY KEY ("id"))`
        );
